...
export default function SettingsTabs({ tabs, activeTab }: { tabs: SettingsTab[]; activeTab: string }) {
                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <Link
                                            ...
                                            onClick={() => setOpen(false)}
                                            className={`border-l-2 px-4 py-3 text-left transition-colors flex flex-row gap-5 ${selected
