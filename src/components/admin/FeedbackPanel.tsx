...
import { Archive, Check, ExternalLink, Sparkles, Trash2, User } from "lucide-react";
...
const STATUS_STYLES: Record<FeedbackStatus, string> = {
	...
	REVIEWED: "border-success/40 bg-success/15 text-success",
	ARCHIVED: "border-border bg-bg-secondary text-text-muted",
};
