...
import { toggleRoadmapVote } from "@/lib/actions/roadmap";
						...
						<div className="flex items-stretch bg-bg-secondary/40">
							{isLoggedIn ? (
								<button
									...
									className={joinClass(
										"flex w-16 shrink-0 flex-col items-center justify-center gap-1 border-r border-border transition-colors disabled:opacity-60",
								...
								<Link
									...
									className="flex w-16 shrink-0 flex-col items-center justify-center gap-1 border-r border-border text-text-muted transition-colors hover:bg-bg-secondary/70 hover:text-text"
								>
							...
							<button
								...
								className="flex min-w-0 flex-1 items-center gap-4 p-5 text-left transition-colors hover:bg-bg-secondary/70"
							>
