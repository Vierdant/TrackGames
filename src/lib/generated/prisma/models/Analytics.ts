...
export type AnalyticsWhereInput = {
  ...
  value?: Prisma.BigIntFilter<"Analytics"> | bigint | number
...
export type AnalyticsScalarWhereWithAggregatesInput = {
  ...
  value?: Prisma.BigIntWithAggregatesFilter<"Analytics"> | bigint | number
...
export type AnalyticsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "updatedAt", ExtArgs["result"]["analytics"]>
...
export interface AnalyticsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const analyticsWithKeyOnly = await prisma.analytics.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Analytics and only return the `key`
   * const analyticsWithKeyOnly = await prisma.analytics.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Analytics and only return the `key`
   * const analyticsWithKeyOnly = await prisma.analytics.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AnalyticsFieldRefs {
  ...
  readonly value: Prisma.FieldRef<"Analytics", 'BigInt'>
