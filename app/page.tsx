				...
				<Container className="relative z-1 flex justify-between gap-10 items-center flex-col lg:flex-row">
					<div className="text-text min-w-100 max-w-100 flex flex-col gap-6 items-center justify-center text-center md:text-start md:justify-start md:items-start">
						<div className="rounded mb-5">
							<h1 className="text-4xl md:text-5xl font-bold text-nowrap">
								Build Your <span className="text-shadow-primary/50 text-shadow-lg">Library</span>
							</h1>
							<p className="text-md md:text-xl text-text-muted font-body mt-5">
			...
			<section className="mt-10">
				<Container>
					<div className="pb-10 border-b-2 border-primary/30 rounded">
						<h1 className="flex flex-row items-center gap-2 text-xl font-bold text-text-muted mb-5">Hits of the Year</h1>
			...
			<section className="mt-10">
				<Container>
					<div className="pb-20 border-b-2 border-primary/30 rounded">
						<h1 className="flex flex-row items-center gap-2 text-xl font-bold text-text-muted mb-5">Playlists</h1>
						{playlists.length ? (
			...
			<section className="mt-10 mb-10">
				<Container>
					<div className="grid grid-cols-2 gap-10 sm:grid-cols-2 lg:grid-cols-4">
						...
						<div className="flex min-w-0 flex-col gap-2">
							<h1 className="text-xl font-bold text-text-muted mb-5 text-nowrap text-center sm:text-start">Coming Soon</h1>
						...
						<div className="flex min-w-0 flex-col gap-2">
							<h1 className="text-xl font-bold text-text-muted mb-5 text-nowrap text-center sm:text-start">Hidden Gems</h1>
