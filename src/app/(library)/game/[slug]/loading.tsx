			...
			<section className="relative min-h-136 w-full md:min-h-152">
				...
				<Container className="relative z-1 flex min-h-136 flex-row items-end justify-center gap-10 pt-20 pb-8 md:min-h-152 md:justify-start">
					<div className="flex min-h-max max-w-full min-w-0 flex-col items-center gap-3 text-text md:flex-row md:items-end md:gap-6">
						<SkeletonBlock className="hidden h-78 w-52 md:block" />
						<SkeletonBlock className="h-67 w-45 md:hidden" />
					</div>
				</Container>
			</section>
			...
			<section className="mt-5 w-full">
				<Container className="flex flex-col justify-between gap-10 lg:flex-row">
					...
					<div className="flex max-w-full min-w-0 shrink-0 flex-col gap-5 lg:w-80">
						...
						<SkeletonBlock className="flex h-18 min-w-0 flex-row items-start justify-start gap-2 rounded bg-bg-secondary p-4" />
						<SkeletonBlock className="flex h-25 min-w-0 flex-row items-start justify-start gap-2 rounded bg-bg-secondary p-4" />
						<SkeletonBlock className="flex h-18 min-w-0 flex-row items-start justify-start gap-2 rounded bg-bg-secondary p-4" />

						<section className="grid min-w-0 grid-cols-3 gap-3">
							<SkeletonBlock className="h-24 border-2 border-primary/30 bg-primary/10" />
							<SkeletonBlock className="h-24 border-2 border-primary/30 bg-primary/10" />
							<SkeletonBlock className="h-24 border-2 border-primary/30 bg-primary/10" />
						</section>
					</div>
				...
				<Container>
					<div className="flex flex-col gap-5">
						<div className="flex flex-row gap-2">
							<SkeletonBlock className="h-10 w-68" />
						</div>
						<div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
							<SkeletonBlock className="aspect-3/4 w-full" />
							<SkeletonBlock className="aspect-3/4 w-full" />
							<SkeletonBlock className="aspect-3/4 w-full" />
							<SkeletonBlock className="hidden aspect-3/4 w-full md:block" />
							<SkeletonBlock className="hidden aspect-3/4 w-full lg:block" />
						</div>
